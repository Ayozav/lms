...
function MainPage() {
    ...
    const cards = [
        ...
        { id: 3, title: 'Моя группа', color: '#fac086', tabId: 'knowledge' },
    ...
    const frameRender = () => {
        ...
        const testBackend = async () => {
            console.log('Кнопка нажата'); // <-- это должно появиться в консоли
            try {
        ...
        // И добавь кнопку куда-нибудь в верстку (временно)
