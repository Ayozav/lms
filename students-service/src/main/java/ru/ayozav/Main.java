...
import ru.ayozav.kafka.consumers.SemesterConsumer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SemesterConsumer semesterConsumer = new SemesterConsumer(JavalinServer.KAFKA_BOOTSTRAP_SERVER, server.getFactory());
